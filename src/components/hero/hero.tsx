...
const Hero = () => {
    ...
    const redirect_to_route = (route: string) => {
        navigate(`/${route}`);
    };

    function sign_up_with_email() {
        redirect_to_route("register");
        setSignedInWithSocials(false);
    }
    ...
    const get_google_signup_details = async () => {
        try {
            ...
            if (typeof displayName === "string" && typeof email === "string") {
                ...
                setRegisterInfo({ ...registerInfo, email, firstName });
    ...
    const get_facebook_signup_details = async () => {
        try {
            ...
            if (typeof displayName === "string" && typeof email === "string") {
                ...
                // set_social_user({ firstName, email });
                setRegisterInfo({ ...registerInfo, email, firstName });
                // redirect_to_route("/email-redirect")
                redirect_to_route("/register");
            }
        } catch (err) {
            setFormError(err as string);
                ...
                <div className="  w-[290px]  lg:h-[465px] lg:w-[547px]  flex justify-between items-center flex-col gap-[3rem] lg:gap-0  ">
                    <div className="w-full gap-2   lg:h-[400px] lg:w-[400px] flex flex-col justify-center lg:gap-3 items-center">
                        ...
                        <div className="flex flex-col gap-3  w-full mt-[1rem] lg:gap-5 items-center">
                            ...
                            >
                                <img
                                    src={Helper.Mail_Black}
                                    alt="lumina google login"
                                />
                ...
                <div className="  w-[300px] h-[500px] flex flex-col gap-[35px] lg:gap-[32px] items-center  lg:w-[500px] ">
                    ...
                    <div className="flex flex-col items-center gap-8">
                        ...
                        <p className="w-11/12  lg:w-[375px] text-[12px] font-[400] lg:text-[14px] ">
                            When you tab{" "}
                            <span className="text-blue-500">continue</span>, you
                            will be sent an email with a verification code sent
                            to your email. The verification code number can be
                            used to logged in.
                        </p>
                        <button
                            onClick={sign_up_with_email}
                            className={`${
                                registerInfo.email.includes("@")
                                    ? "text-white bg-[#F74887]"
                                    : "text-[#808080] bg-[#CCCCCCBD]"
                            } h-[] lg:h-[58px] lg:w-[261px] rounded-[32px] px-[24px] py-[10px]  lg:font-[700] text-[18px]  `}
                        >
                            Continue
                        </button>
                    </div>
                        ...
                        <div className="lg:h-[370px]  flex flex-col gap-[3rem] lg:gap-3 lg:justify-between ">
                            <form onSubmit={handle_login_user}>
                                <div className="flex flex-col items-center gap-4 lg:gap-5 ">
                                    ...
                                    <div className="lg:h-[46px] w-11/12 lg:w-auto ">
                                        <input
                                            type="password"
                                            name="password"
