        ...
        <div className="col-span-12 h-full lg:col-span-8  w-full lg:mt-[3rem] ">
          <div className="h-[52px]  lg:w-[520px] flex lg:mx-auto ">
            <motion.div
              ...
              className={`${
                tabs === 0
                  ? " border-[#EDF0F7] text-[#F93333BD]"
                  : "text-[#555555] border-[#EDF0F7]"
              } relative w-[50%] border h-full  flex justify-center items-center font-[700] text-[18px]  lg:text-[20px] cursor-pointer`}
            >
              Edit
              {tabs === 0 && (
                <motion.div
                  ...
                  layoutId="tab"
                  className="w-full h-full absolute top-0 bg-[#CBD2E0] z-[-1]"
                />
              )}
            </motion.div>
            <motion.div
              ...
              className={`${
                tabs === 1
                  ? " border-[#EDF0F7] text-[#F93333BD]"
                  : "text-[#555555] border-[#EDF0F7]"
              } relative w-[50%] h-full flex justify-center items-center z-[99] font-[700] text-[18px] lg:text-[20px] border cursor-pointer`}
            >
              Preview
              {tabs === 1 && (
                <motion.div
          ...
          <div className="border-4 border-green-500">
            {
              !tabs ? (
                ...
                layoutId="tab-item"
                >
                  <div className="w-full h-[500px] border-red-500 border-4  lg:w-[520px] lg:h-[654px] lg:mx-auto">
                    <img
                ...
                transition={{duration: 2,}}
                layoutId="tab-item"
                className="flex justify-center items-center h-[50rem]">
                  <h1> nothing here</h1>
                </motion.div>
              )
            }
